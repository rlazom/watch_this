...
import '../modules/filter/view_model/filter_view_model.dart';
import '../modules/filter/views/filter_page.dart';
...
export '../modules/filter/views/filter_page.dart';
...
const String filter = FilterPage.route;
...
final Map<String, Widget Function(BuildContext)> routes = {
  ...
  filter: (context) => FilterPage(viewModel: FilterViewModel()),
